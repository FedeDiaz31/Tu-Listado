      ...
      <form onSubmit={(event) => event.preventDefault()}>
        <div className="container" style={{ width: "800px" }}>
          ...
          <div className="d-flex align-items-end mt-4 mb-2">
            ...
            />
            <label htmlFor="quantity" className="text-light fw-bold ms-3 me-2">
              Cantidad
            </label>
            <input
              name="quantity"
                  ...
                  >
                    <div className="d-flex justify-content-between check-input ">
                      ...
                      <div className="d-flex justify-content-start">
                        {product.quantity > 1 && (
                          <p className="ms-5">{product.quantity} unidades</p>
                        )}
                        {product.quantity === 1 && (
                          <p className="ms-5">{product.quantity} unidad</p>
                        )}

                        {product.price > 0 && (
                          <p className="ms-2">por ${product.price}</p>
                        )}
                      </div>
                    </div>
